...
- go-musicfox
一个用go语言实现的终端网易云播放器，可以通过密码和二维码方式登录网易云
...
- Distro-grub-themes
不同发行版本的grub的主题，可以根据实际安装的发行版配置
https://github.com/AdisonCavani/distro-grub-themes.git

- zoddDev的bspwm配置安装repo
另外一个很不错的bspwm配置方案，基于Arch Linux的安装脚本
...
- Hybrid Font
热心人创建的一个复合等宽字体，支持中英文等宽适合在编辑器中使用
